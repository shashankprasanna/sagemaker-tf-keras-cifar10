...
def main(args):
    ...
    train_dataset = process_input(args.epochs, args.batch_size, args.train, 'train')
    eval_dataset = process_input(args.epochs, args.batch_size, args.eval, 'eval')
    validation_dataset = process_input(args.epochs, args.batch_size, args.validation, 'validation')
